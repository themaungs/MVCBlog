...
using MyBlogSite.ViewModels.Identity;
...
namespace MyBlogSite
{
    ...
    public class MyBlogSiteUserManager : UserManager<MyBlogSiteUser>
    {
        ...
        public static MyBlogSiteUserManager Create(IdentityFactoryOptions<MyBlogSiteUserManager> options, IOwinContext context) 
        {
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<MyBlogSiteUser>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<MyBlogSiteUser>
            {
    ...
    public class ApplicationSignInManager : SignInManager<MyBlogSiteUser, string>
    {
        public ApplicationSignInManager(MyBlogSiteUserManager userManager, IAuthenticationManager authenticationManager)
        ...
        {
            return new ApplicationSignInManager(context.GetUserManager<MyBlogSiteUserManager>(), context.Authentication);
        }
    }
}
